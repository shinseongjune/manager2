...
public class NewGameSceneManager : MonoBehaviour
{
    ...
    readonly string[] teamNamePrefix = { "´ë±¸", "¼­¿ï", "ÀÎÃµ", "µå··Å«", "½ºÄ­µğ³ªºñ¾È", "ºò", "½º¸ô", "¾î¸ŞÀÌÂ¡" };
    readonly string[] teamNameSuffix = { "¶óÀÌ¿ÂÁî", "º£¾î½º", "Å¸ÀÌ°ÅÁî", "°ø¹ú·¹´Ü", "·ÎÄÏ´Ü", "Æ®À©½º", "½ºÅ¸Áî" };
